...
from grove.core.config import DEFAULT_CONFIG
...
def init(
    ...
    if not yes and not local:
        ...
        if is_interactive():
            from grove.tui.apps.intro import IntroApp
            from grove.tui.apps.init_wizard import run_init_wizard
...
def _execute_setup(
    *,
    ...
    if install_alias and alias_text:
        try:
            from grove.commands.alias import _get_rc_file
...
def handle(event: str):
    ...
    if event == "session-init":
        ...
        try:
            from grove.core.trace import open_trace_db, start_session
        ...
        try:
            ...
            from grove.core import paths as _paths
            ...
            from grove.core.search import open_db, search_keyword, format_results
        ...
        try:
            from grove.core.context import build_precompact_warning
        ...
        try:
            from grove.core.trace import end_session, open_trace_db
