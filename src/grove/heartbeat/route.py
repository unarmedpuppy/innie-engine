...
from grove.core.collector import load_heartbeat_state, save_heartbeat_state
...
def route_sessions(collected: dict | None, agent: str | None = None) -> int:
    ...
    try:
        from grove.core.search import index_session, open_db
...
def route_topic_catalog(agent: str | None = None) -> bool:
    ...
    try:
        from grove.core.catalog import build_topic_catalog, save_topic_catalog
...
def route_auto_compress_context(agent: str | None = None, collected: dict | None = None) -> int:
    ...
    from grove.core.context import compress_context_open_items, estimate_tokens
